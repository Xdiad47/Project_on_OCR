...
import com.camdiad.characterrecognizer.camera.CameraManager;
import com.camdiad.characterrecognizer.camera.ShutterButton;
import com.camdiad.characterrecognizer.language.LanguageCodeHelper;
import com.camdiad.characterrecognizer.language.TranslateAsyncTask;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, 
  ...
  private File getStorageDirectory() {
    ...
    if (Environment.MEDIA_MOUNTED.equals(Environment.getExternalStorageState())) {
      ...
      //          // "/mnt/sdcard/Android/data/com.camdiad.characterrecognizer/files/"
